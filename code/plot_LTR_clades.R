...
#-------------------------------------------------
gff_file <- "assembly_primary_contig.fa.mod.LTR.intact.raw.gff3"
cls_file <- "../assembly_primary_contig.fa.mod.LTR.raw.fa.rexdb-plant.cls.tsv"
...
setwd("/data/users/ppilipczuk/OrganizationAndAnnotationOfEkuaryoticGenomes/results")
ggsave("clade_plots/01_LTR_Copia_Gypsy_cladelevel.png", combined, width = 12, height = 10, dpi = 300)
ggsave("clade_plots/01_LTR_Copia_Gypsy_cladelevel.pdf", combined, width = 12, height = 10)