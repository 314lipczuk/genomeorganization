...
data <- "/home/ppilipczuk/data/OrganizationAndAnnotationOfEkuaryoticGenomes/results/EDTA_annotation/assembly_primary_contig.fa.mod.EDTA.anno/assembly_primary_contig.fa.mod.out.landscape.Div.Rname.tab"
...
ggsave(filename = "results/div/output.pdf", width = 10, height = 5, useDingbats = F)
